export const productsData = [
	...
	},
	{
		...
		price: 109,
		description:
			'3D NAND flash are applied to deliver high transfer speeds. The advanced SLC Cache Technology allows performance boost and longer lifespan.',
		category: 'electronics',
	...
	},
	{
		...
		price: 29.95,
		description:
			'100% POLYURETHANE (shell) 100% POLYESTER (lining) Imported Zipper closure Hand Wash Only Sleeve style: Long Sleeve Lightweight fabric with great stretch for comfort.',
		category: "women's clothing",
